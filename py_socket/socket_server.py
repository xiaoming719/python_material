# -*- coding: utf-8 -*-
"""
Created on Sun Apr 22 13:11:55 2018
        ...
        while True:  #循环轮询socket状态，等待访问  
                ...
                try:    
                        ...
                        while True:  
                                ...
                                print ("Get value " +buf.decode("gb2312"))  
                                if buf == '1':    
                                    print ("send welcome") 
                                    connection.send('welcome to server!'.encode(encoding="gb2312"))    
                                elif buf!='0':    
                                    connection.send('please go out!'.encode(encoding="gb2312"))   
                                    print ("send refuse")  
                                else:   
                                    print ("close")
                                    break  #退出连接监听循环  
